 ...
 * Also check this file in linux kernel
...
#define BCM2835_IRQNR_SPI         GPU_IRQ(54)
#define BCM2835_IRQNR_PCM         GPU_IRQ(55)
#define BCM2835_IRQNR_SDHOST      GPU_IRQ(56)
#define BCM2835_IRQNR_UART0       GPU_IRQ(57)
#define BCM2835_IRQNR_ARASAN_SDIO GPU_IRQ(62)
