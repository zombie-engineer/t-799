...
#define BCM2835_CLOCK_GND 52
#define BCM2835_CLOCK_OSC 53
#define BCM2835_CLOCK_TESTDEBUG0 54
#define BCM2835_CLOCK_TESTDEBUG1 55
#define BCM2835_CLOCK_UNKNOWN 56
#define BCM2835_CLOCK_NONE 57

bool bcm_cm_get_clock_info(int clock_id, bool *enabled, int *parent_clock_id,
  int *div, const char **clock_name);
