...
#define BCM2835_EMMC_BLKSIZECNT_CLR_BLKSIZE(v)           BF_CLEAR(v, 0 , 10)
#define BCM2835_EMMC_BLKSIZECNT_CLR_BLKCNT(v)            BF_CLEAR(v, 16, 16)
...
#define BCM2835_EMMC_ARG1_CLR_ARGUMENT(v)                BF_CLEAR(v, 0 , 32)
...
#define BCM2835_EMMC_CMDTM_CLR_TM_BLKCNT_EN(v)           BF_CLEAR(v, 1 , 1 )
#define BCM2835_EMMC_CMDTM_CLR_TM_AUTOCMD_EN(v)          BF_CLEAR(v, 2 , 2 )
#define BCM2835_EMMC_CMDTM_CLR_TM_DAT_DIR(v)             BF_CLEAR(v, 4 , 1 )
#define BCM2835_EMMC_CMDTM_CLR_TM_MULTI_BLOCK(v)         BF_CLEAR(v, 5 , 1 )
#define BCM2835_EMMC_CMDTM_CLR_CMD_RSPNS_TYPE(v)         BF_CLEAR(v, 16, 2 )
#define BCM2835_EMMC_CMDTM_CLR_CMD_CRCCHK_EN(v)          BF_CLEAR(v, 19, 1 )
#define BCM2835_EMMC_CMDTM_CLR_CMD_IXCHK_EN(v)           BF_CLEAR(v, 20, 1 )
#define BCM2835_EMMC_CMDTM_CLR_CMD_ISDATA(v)             BF_CLEAR(v, 21, 1 )
#define BCM2835_EMMC_CMDTM_CLR_CMD_TYPE(v)               BF_CLEAR(v, 22, 2 )
#define BCM2835_EMMC_CMDTM_CLR_CMD_INDEX(v)              BF_CLEAR(v, 24, 6 )
...
#define BCM2835_EMMC_RESP0_CLR_RESPONSE(v)          BF_CLEAR(v, 0 , 32)
...
#define BCM2835_EMMC_RESP1_CLR_RESPONSE(v)          BF_CLEAR(v, 0 , 32)
...
#define BCM2835_EMMC_RESP2_CLR_RESPONSE(v)               BF_CLEAR(v, 0 , 32)
...
#define BCM2835_EMMC_RESP3_CLR_RESPONSE(v)               BF_CLEAR(v, 0 , 32)
...
#define BCM2835_EMMC_DATA_CLR_DATA(v)                    BF_CLEAR(v, 0 , 32)
...
#define BCM2835_EMMC_STATUS_CLR_CMD_INHIBIT(v)           BF_CLEAR(v, 0 , 1 )
#define BCM2835_EMMC_STATUS_CLR_DAT_INHIBIT(v)           BF_CLEAR(v, 1 , 1 )
#define BCM2835_EMMC_STATUS_CLR_DAT_ACTIVE(v)            BF_CLEAR(v, 2 , 1 )
#define BCM2835_EMMC_STATUS_CLR_WRITE_TRANSFER(v)        BF_CLEAR(v, 8 , 1 )
#define BCM2835_EMMC_STATUS_CLR_READ_TRANSFER(v)         BF_CLEAR(v, 9 , 1 )
#define BCM2835_EMMC_STATUS_CLR_DAT_LEVEL0(v)            BF_CLEAR(v, 20, 4 )
#define BCM2835_EMMC_STATUS_CLR_CMD_LEVEL(v)             BF_CLEAR(v, 24, 1 )
#define BCM2835_EMMC_STATUS_CLR_DAT_LEVEL1(v)            BF_CLEAR(v, 25, 4 )
...
#define BCM2835_EMMC_CONTROL0_CLR_HCTL_DWIDTH(v)         BF_CLEAR(v, 1 , 1 )
#define BCM2835_EMMC_CONTROL0_CLR_HCTL_HS_EN(v)          BF_CLEAR(v, 2 , 1 )
#define BCM2835_EMMC_CONTROL0_CLR_HCTL_8BIT(v)           BF_CLEAR(v, 5 , 1 )
#define BCM2835_EMMC_CONTROL0_CLR_GAP_STOP(v)            BF_CLEAR(v, 16, 1 )
#define BCM2835_EMMC_CONTROL0_CLR_GAP_RESTART(v)         BF_CLEAR(v, 17, 1 )
#define BCM2835_EMMC_CONTROL0_CLR_READWAIT_EN(v)         BF_CLEAR(v, 18, 1 )
#define BCM2835_EMMC_CONTROL0_CLR_GAP_IEN(v)             BF_CLEAR(v, 19, 1 )
#define BCM2835_EMMC_CONTROL0_CLR_SPI_MODE(v)            BF_CLEAR(v, 20, 1 )
#define BCM2835_EMMC_CONTROL0_CLR_BOOT_EN(v)             BF_CLEAR(v, 21, 1 )
#define BCM2835_EMMC_CONTROL0_CLR_ALT_BOOT_EN(v)         BF_CLEAR(v, 22, 1 )
...
#define BCM2835_EMMC_CONTROL1_GET_CLK_FREQ8(v)           BITS_EXTRACT32(v, 8 , 6 )
...
#define BCM2835_EMMC_CONTROL1_CLR_SET_CLK_FREQ8(v, set)          B_CLEAR_AND_SET32(v, set, 8 , 6 )
...
#define BCM2835_EMMC_CONTROL1_CLR_CLK_FREQ8(v)           B_CLEAR32(v, 8 , 6 )
...
#define BCM2835_EMMC_CONTROL1_MASK_CLK_FREQ8             BF_MAKE_MASK32(8, 6)
...
#define BCM2835_EMMC_INTERRUPT_CLR_CMD_DONE(v)           BF_CLEAR(v, 0 , 1 )
#define BCM2835_EMMC_INTERRUPT_CLR_DATA_DONE(v)          BF_CLEAR(v, 1 , 1 )
#define BCM2835_EMMC_INTERRUPT_CLR_BLOCK_GAP(v)          BF_CLEAR(v, 2 , 1 )
#define BCM2835_EMMC_INTERRUPT_CLR_WRITE_RDY(v)          BF_CLEAR(v, 4 , 1 )
#define BCM2835_EMMC_INTERRUPT_CLR_READ_RDY(v)           BF_CLEAR(v, 5 , 1 )
#define BCM2835_EMMC_INTERRUPT_CLR_CARD(v)               BF_CLEAR(v, 8 , 1 )
#define BCM2835_EMMC_INTERRUPT_CLR_RETUNE(v)             BF_CLEAR(v, 12, 1 )
#define BCM2835_EMMC_INTERRUPT_CLR_BOOTACK(v)            BF_CLEAR(v, 13, 1 )
#define BCM2835_EMMC_INTERRUPT_CLR_ENDBOOT(v)            BF_CLEAR(v, 14, 1 )
#define BCM2835_EMMC_INTERRUPT_CLR_ERR(v)                BF_CLEAR(v, 15, 1 )
#define BCM2835_EMMC_INTERRUPT_CLR_CTO_ERR(v)            BF_CLEAR(v, 16, 1 )
#define BCM2835_EMMC_INTERRUPT_CLR_CCRC_ERR(v)           BF_CLEAR(v, 17, 1 )
#define BCM2835_EMMC_INTERRUPT_CLR_CEND_ERR(v)           BF_CLEAR(v, 18, 1 )
#define BCM2835_EMMC_INTERRUPT_CLR_CBAD_ERR(v)           BF_CLEAR(v, 19, 1 )
#define BCM2835_EMMC_INTERRUPT_CLR_DTO_ERR(v)            BF_CLEAR(v, 20, 1 )
#define BCM2835_EMMC_INTERRUPT_CLR_DCRC_ERR(v)           BF_CLEAR(v, 21, 1 )
#define BCM2835_EMMC_INTERRUPT_CLR_DEND_ERR(v)           BF_CLEAR(v, 22, 1 )
#define BCM2835_EMMC_INTERRUPT_CLR_ACMD_ERR(v)           BF_CLEAR(v, 24, 1 )
...
#define BCM2835_EMMC_IRPT_MASK_CLR_CMD_DONE(v)           BF_CLEAR(v, 0 , 1 )
#define BCM2835_EMMC_IRPT_MASK_CLR_DATA_DONE(v)          BF_CLEAR(v, 1 , 1 )
#define BCM2835_EMMC_IRPT_MASK_CLR_BLOCK_GAP(v)          BF_CLEAR(v, 2 , 1 )
#define BCM2835_EMMC_IRPT_MASK_CLR_WRITE_RDY(v)          BF_CLEAR(v, 4 , 1 )
#define BCM2835_EMMC_IRPT_MASK_CLR_READ_RDY(v)           BF_CLEAR(v, 5 , 1 )
#define BCM2835_EMMC_IRPT_MASK_CLR_CARD(v)               BF_CLEAR(v, 8 , 1 )
#define BCM2835_EMMC_IRPT_MASK_CLR_RETUNE(v)             BF_CLEAR(v, 12, 1 )
#define BCM2835_EMMC_IRPT_MASK_CLR_BOOTACK(v)            BF_CLEAR(v, 13, 1 )
#define BCM2835_EMMC_IRPT_MASK_CLR_ENDBOOT(v)            BF_CLEAR(v, 14, 1 )
#define BCM2835_EMMC_IRPT_MASK_CLR_ERR(v)                BF_CLEAR(v, 15, 1 )
#define BCM2835_EMMC_IRPT_MASK_CLR_CTO_ERR(v)            BF_CLEAR(v, 16, 1 )
#define BCM2835_EMMC_IRPT_MASK_CLR_CCRC_ERR(v)           BF_CLEAR(v, 17, 1 )
#define BCM2835_EMMC_IRPT_MASK_CLR_CEND_ERR(v)           BF_CLEAR(v, 18, 1 )
#define BCM2835_EMMC_IRPT_MASK_CLR_CBAD_ERR(v)           BF_CLEAR(v, 19, 1 )
#define BCM2835_EMMC_IRPT_MASK_CLR_DTO_ERR(v)            BF_CLEAR(v, 20, 1 )
#define BCM2835_EMMC_IRPT_MASK_CLR_DCRC_ERR(v)           BF_CLEAR(v, 21, 1 )
#define BCM2835_EMMC_IRPT_MASK_CLR_DEND_ERR(v)           BF_CLEAR(v, 22, 1 )
#define BCM2835_EMMC_IRPT_MASK_CLR_ACMD_ERR(v)           BF_CLEAR(v, 24, 1 )
...
#define BCM2835_EMMC_IRPT_EN_CLR_CMD_DONE(v)             BF_CLEAR(v, 0 , 1 )
#define BCM2835_EMMC_IRPT_EN_CLR_DATA_DONE(v)            BF_CLEAR(v, 1 , 1 )
#define BCM2835_EMMC_IRPT_EN_CLR_BLOCK_GAP(v)            BF_CLEAR(v, 2 , 1 )
#define BCM2835_EMMC_IRPT_EN_CLR_WRITE_RDY(v)            BF_CLEAR(v, 4 , 1 )
#define BCM2835_EMMC_IRPT_EN_CLR_READ_RDY(v)             BF_CLEAR(v, 5 , 1 )
#define BCM2835_EMMC_IRPT_EN_CLR_CARD(v)                 BF_CLEAR(v, 8 , 1 )
#define BCM2835_EMMC_IRPT_EN_CLR_RETUNE(v)               BF_CLEAR(v, 12, 1 )
#define BCM2835_EMMC_IRPT_EN_CLR_BOOTACK(v)              BF_CLEAR(v, 13, 1 )
#define BCM2835_EMMC_IRPT_EN_CLR_ENDBOOT(v)              BF_CLEAR(v, 14, 1 )
#define BCM2835_EMMC_IRPT_EN_CLR_ERR(v)                  BF_CLEAR(v, 15, 1 )
#define BCM2835_EMMC_IRPT_EN_CLR_CTO_ERR(v)              BF_CLEAR(v, 16, 1 )
#define BCM2835_EMMC_IRPT_EN_CLR_CCRC_ERR(v)             BF_CLEAR(v, 17, 1 )
#define BCM2835_EMMC_IRPT_EN_CLR_CEND_ERR(v)             BF_CLEAR(v, 18, 1 )
#define BCM2835_EMMC_IRPT_EN_CLR_CBAD_ERR(v)             BF_CLEAR(v, 19, 1 )
#define BCM2835_EMMC_IRPT_EN_CLR_DTO_ERR(v)              BF_CLEAR(v, 20, 1 )
#define BCM2835_EMMC_IRPT_EN_CLR_DCRC_ERR(v)             BF_CLEAR(v, 21, 1 )
#define BCM2835_EMMC_IRPT_EN_CLR_DEND_ERR(v)             BF_CLEAR(v, 22, 1 )
#define BCM2835_EMMC_IRPT_EN_CLR_ACMD_ERR(v)             BF_CLEAR(v, 24, 1 )
...
#define BCM2835_EMMC_FORCE_IRPT_CLR_CMD_DONE(v)          BF_CLEAR(v, 0 , 1 )
#define BCM2835_EMMC_FORCE_IRPT_CLR_DATA_DONE(v)         BF_CLEAR(v, 1 , 1 )
#define BCM2835_EMMC_FORCE_IRPT_CLR_BLOCK_GAP(v)         BF_CLEAR(v, 2 , 1 )
#define BCM2835_EMMC_FORCE_IRPT_CLR_WRITE_RDY(v)         BF_CLEAR(v, 4 , 1 )
#define BCM2835_EMMC_FORCE_IRPT_CLR_READ_RDY(v)          BF_CLEAR(v, 5 , 1 )
#define BCM2835_EMMC_FORCE_IRPT_CLR_CARD(v)              BF_CLEAR(v, 8 , 1 )
#define BCM2835_EMMC_FORCE_IRPT_CLR_RETUNE(v)            BF_CLEAR(v, 12, 1 )
#define BCM2835_EMMC_FORCE_IRPT_CLR_BOOTACK(v)           BF_CLEAR(v, 13, 1 )
#define BCM2835_EMMC_FORCE_IRPT_CLR_ENDBOOT(v)           BF_CLEAR(v, 14, 1 )
#define BCM2835_EMMC_FORCE_IRPT_CLR_ERR(v)               BF_CLEAR(v, 15, 1 )
#define BCM2835_EMMC_FORCE_IRPT_CLR_CTO_ERR(v)           BF_CLEAR(v, 16, 1 )
#define BCM2835_EMMC_FORCE_IRPT_CLR_CCRC_ERR(v)          BF_CLEAR(v, 17, 1 )
#define BCM2835_EMMC_FORCE_IRPT_CLR_CEND_ERR(v)          BF_CLEAR(v, 18, 1 )
#define BCM2835_EMMC_FORCE_IRPT_CLR_CBAD_ERR(v)          BF_CLEAR(v, 19, 1 )
#define BCM2835_EMMC_FORCE_IRPT_CLR_DTO_ERR(v)           BF_CLEAR(v, 20, 1 )
#define BCM2835_EMMC_FORCE_IRPT_CLR_DCRC_ERR(v)          BF_CLEAR(v, 21, 1 )
#define BCM2835_EMMC_FORCE_IRPT_CLR_DEND_ERR(v)          BF_CLEAR(v, 22, 1 )
#define BCM2835_EMMC_FORCE_IRPT_CLR_ACMD_ERR(v)          BF_CLEAR(v, 24, 1 )
...
#define BCM2835_EMMC_CONTROL2_CLR_ACKNOX_ERR(v)          BF_CLEAR(v, 0 , 1 )
#define BCM2835_EMMC_CONTROL2_CLR_ACTO_ERR(v)            BF_CLEAR(v, 1 , 1 )
#define BCM2835_EMMC_CONTROL2_CLR_ACCRC_ERR(v)           BF_CLEAR(v, 2 , 1 )
#define BCM2835_EMMC_CONTROL2_CLR_ACEND_ERR(v)           BF_CLEAR(v, 3 , 1 )
#define BCM2835_EMMC_CONTROL2_CLR_ACBAD_ERR(v)           BF_CLEAR(v, 4 , 1 )
#define BCM2835_EMMC_CONTROL2_CLR_NOTC12_ERR(v)          BF_CLEAR(v, 7 , 1 )
#define BCM2835_EMMC_CONTROL2_CLR_UHSMODE(v)             BF_CLEAR(v, 16, 3 )
#define BCM2835_EMMC_CONTROL2_CLR_TUNEON(v)              BF_CLEAR(v, 22, 1 )
#define BCM2835_EMMC_CONTROL2_CLR_TUNED(v)               BF_CLEAR(v, 23, 1 )
...
#define BCM2835_EMMC_BOOT_TIMEOUT_CLR_TIMEOUT(v)         BF_CLEAR(v, 0 , 32)
...
#define BCM2835_EMMC_DBG_SEL_CLR_SELECT(v)               BF_CLEAR(v, 0 , 1 )
...
#define BCM2835_EMMC_EXRDFIFO_CFG_CLR_RD_THRSH(v)        BF_CLEAR(v, 0 , 3 )
...
#define BCM2835_EMMC_EXRDFIFO_EN_CLR_ENABLE(v)           BF_CLEAR(v, 0 , 1 )
...
#define BCM2835_EMMC_TUNE_STEP_CLR_DELAY(v)              BF_CLEAR(v, 0 , 3 )
...
#define BCM2835_EMMC_TUNE_STEPS_STD_CLR_STEPS(v)         BF_CLEAR(v, 0 , 6 )
...
#define BCM2835_EMMC_TUNE_STEPS_DDR_CLR_STEPS(v)         BF_CLEAR(v, 0 , 6 )
...
#define BCM2835_EMMC_SPI_INT_SPT_CLR_SELECT(v)           BF_CLEAR(v, 0 , 8 )
...
#define BCM2835_EMMC_SLOTISR_VER_CLR_SLOT_STATUS(v)      BF_CLEAR(v, 0 , 8 )
#define BCM2835_EMMC_SLOTISR_VER_CLR_SDVERSION(v)        BF_CLEAR(v, 16, 8 )
#define BCM2835_EMMC_SLOTISR_VER_CLR_VENDOR(v)           BF_CLEAR(v, 24, 8 )
...
#define BCM2835_EMMC_CARD_STATUS_CLR_AKE_SEQ_ERROR(v)    BF_CLEAR(v, 3 , 1 )
#define BCM2835_EMMC_CARD_STATUS_CLR_APP_CMD(v)          BF_CLEAR(v, 5 , 1 )
#define BCM2835_EMMC_CARD_STATUS_CLR_FX_EVENT(v)         BF_CLEAR(v, 6 , 1 )
#define BCM2835_EMMC_CARD_STATUS_CLR_READY_FOR_DATA(v)   BF_CLEAR(v, 8 , 1 )
#define BCM2835_EMMC_CARD_STATUS_CLR_CURRENT_STATE(v)    BF_CLEAR(v, 9 , 4 )
#define BCM2835_EMMC_CARD_STATUS_CLR_ERASE_RESET(v)      BF_CLEAR(v, 13, 1 )
#define BCM2835_EMMC_CARD_STATUS_CLR_CARD_ECC_DISABLED(v) BF_CLEAR(v, 14, 1 )
#define BCM2835_EMMC_CARD_STATUS_CLR_WP_ERASE_SKIP(v)    BF_CLEAR(v, 15, 1 )
#define BCM2835_EMMC_CARD_STATUS_CLR_CSD_OVERWRITE(v)    BF_CLEAR(v, 16, 1 )
#define BCM2835_EMMC_CARD_STATUS_CLR_ERROR(v)            BF_CLEAR(v, 19, 1 )
#define BCM2835_EMMC_CARD_STATUS_CLR_CC_ERROR(v)         BF_CLEAR(v, 20, 1 )
#define BCM2835_EMMC_CARD_STATUS_CLR_CARD_ECC_FAILED(v)  BF_CLEAR(v, 21, 1 )
#define BCM2835_EMMC_CARD_STATUS_CLR_ILLEGAL_COMMAND(v)  BF_CLEAR(v, 22, 1 )
#define BCM2835_EMMC_CARD_STATUS_CLR_COM_CRC_ERROR(v)    BF_CLEAR(v, 23, 1 )
#define BCM2835_EMMC_CARD_STATUS_CLR_LOCK_UNLOCK_FAILED(v) BF_CLEAR(v, 24, 1 )
#define BCM2835_EMMC_CARD_STATUS_CLR_CARD_IS_LOCKED(v)   BF_CLEAR(v, 25, 1 )
#define BCM2835_EMMC_CARD_STATUS_CLR_WP_VIOLATION(v)     BF_CLEAR(v, 26, 1 )
#define BCM2835_EMMC_CARD_STATUS_CLR_ERASE_PARAM(v)      BF_CLEAR(v, 27, 1 )
#define BCM2835_EMMC_CARD_STATUS_CLR_ERASE_SEQ_ERROR(v)  BF_CLEAR(v, 28, 1 )
#define BCM2835_EMMC_CARD_STATUS_CLR_BLOCK_LEN_ERROR(v)  BF_CLEAR(v, 29, 1 )
#define BCM2835_EMMC_CARD_STATUS_CLR_ADDRESS_ERROR(v)    BF_CLEAR(v, 30, 1 )
#define BCM2835_EMMC_CARD_STATUS_CLR_OUT_OF_RANGE(v)     BF_CLEAR(v, 31, 1 )
