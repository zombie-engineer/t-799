...
const struct gfx_glyph FreeSans8pt7bGlyphs[] = {
  {     0,   1,   1,   4,    0,    0 },   // 0x20 ' '
  {     1,   1,  11,   4,    2,  -10 },   // 0x21 '!'
  {     3,   4,   4,   6,    1,  -10 },   // 0x22 '"'
  {     5,   9,  11,   9,    0,  -10 },   // 0x23 '#'
...
const struct gfx_font font_free_sans_8pt_7b = {
  .bitmap = (uint8_t  *)FreeSans8pt7bBitmaps,
  .glyph = (struct gfx_glyph *)FreeSans8pt7bGlyphs,
  .first = 0x20,
  .last = 0x7E,
  .y_advance = 26
};
